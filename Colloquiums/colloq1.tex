...
\end{proof}
   ...
   \definition{
    ...
    & 3. \; \| \alpha x \|  = |\alpha| \cdot \| x \| \; \forall \, x \in \mathbb{V}, \alpha \in D. \\ \\
    ...
    & 3. \; \| \alpha f \|  = \sup_{x \in D} |\alpha \cdot f(x)| = |\alpha| \sup_{x \in D} |f(x)| = |\alpha | \cdot \| f \| \; \forall \, f \in \mathbb{V}, \alpha \in  D. \\
    \end{flalign} 
    \end{proof}
	...
	то есть $\forall \delta > 0 \;\; \forall x \in U_{\delta}(x_0) \;\; f(x) = \sum_{n = 0}^{\infty} c_n (x - x_0)^n$. 
