...
\begin{document}
    ...
    \begin{flalign*}
        ...
        & \text{нет, ребята, это жестко, } \\
        & \implies \text{ но ряд расходится к 0}
    \end{flalign*}
    ...
    \begin{flalign*}
        ...
        -\frac{1}{2(1 + n^2)} \to 0 \text{ при } n \to \infty\\
%        & \lim_{n \to \infty} a_n = \lim_{n \to \infty} \ln \left( 1 + \left( 1 - \sqrt[n]{n} \right) \right) = 
%        \lim_{n \to \infty} \left( 1 - \sqrt[n]{n} \right) = 0 \\
%        & \lim_{n \to \infty} a_n = 0
%        \implies \text{ ряд расходится к 0}
   \end{flalign*}
