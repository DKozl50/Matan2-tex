...
\begin{document}
   ...
   \end{flalign*}
    ...
    \begin{flalign*}
        ...
        & a_n = 1 - 1 - \frac{1}{2 \left( 1 + \frac{\sin n}{\sqrt{n}} \right)}
         + o\left( \frac{1}{1 + \frac{\sin n}{\sqrt{n}}} \right)
         \xrightarrow{n \to \infty} \frac12 \ne 0 \; \Rightarrow \\
        & \Rightarrow \; \sum\limits_{n = 1}^{\infty} \ln \left( 1 - \frac{\sin n}{\sqrt{n} + \sin n} \right)  
        \text{ расходится, т.к. не выполнено необходимое условие сходимости } \implies \\
