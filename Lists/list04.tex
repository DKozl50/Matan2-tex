...
\begin{document}
    \maketitle
    \section*{Вычислите бесконечные произведения как предел частичного.}
    %Task 1
    \subsection*{Задача 1}
    \begin{flalign*}
    ...
    \end{flalign*}
    \section*{Исследуйте функциональную последовательность $f_n$ на равномерную сходимость к
    поточечному пределу $f$ на множестве $D$, оценивая $\norm{f_n - f}$.}
    ...
    \end{flalign*}
    \section*{Докажите неравномерную сходимость функциональной последовательности на
    заданном множестве, применяя теорему Дини.}
    ...
    \end{flalign*}
    \section*{Докажите неравномерную сходимость функциональной последовательности на
    заданном множестве, применяя локализацию особенности.}
